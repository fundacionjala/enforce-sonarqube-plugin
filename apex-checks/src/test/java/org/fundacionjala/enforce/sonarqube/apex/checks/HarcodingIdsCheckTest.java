...
public class HarcodingIdsCheckTest {
    ...
    private static final String FIRST_EXPRESSION_ERROR_MESSAGE = "Statement contains hard-coded value '4654134167168118'.";
    private static final String SECOND_EXPRESSION_ERROR_MESSAGE = "Statement contains hard-coded value '65469451346546135'.";
    private static final String THIRD_EXPRESSION_ERROR_MESSAGE = "Statement contains hard-coded value '546546455454654AWB'.";
    private static final String FOURTH_EXPRESSION_ERROR_MESSAGE = "Statement contains hard-coded value '554546546465456'.";
